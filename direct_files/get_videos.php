<?php
    ...
    $i=0;
    foreach($config->services as $serv){
        if(in_array($serv->origin,explode(",",$_POST["type"]))){
            $nbServ++;
            ...
            $url_api = str_replace("TYPE","video",$url_api);
            ...
            while($k <10 and isset($searchResponse[$k])){
                ...
                array_push($final_liste, array('nom_video' => $name, 
                                    'code' => $code, 
                                    'origine' => $origine, 
